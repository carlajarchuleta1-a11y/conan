...
class ConanBasicApp:
    def __init__(self, conan_api):
        ...
        self.cache = conan_api._pkg_cache # noqa
        self.remote_manager = conan_api._remote_manager # noqa
...
class ConanApp(ConanBasicApp):
    def __init__(self, conan_api):
        ...
        self.proxy = ConanProxy(conan_api._pkg_cache, conan_api._remote_manager,  # noqa
                                self.global_conf, self.editable_packages)
        ...
        cmd_wrap = CmdWrapper(HomePaths(self.conan_api.home_folder).wrapper_path)
        conanfile_helpers = ConanFileHelpers(conan_api._requester, cmd_wrap, self.global_conf, # noqa
                                             self.cache, conan_api.home_folder)
...
class LocalRecipesIndexApp:
    ...
    def __init__(self, cache_folder):
        ...
        self.proxy = ConanProxy(self.cache, self.remote_manager, self.global_conf,
                                editable_packages)
